	...
	return (
		<div className="mt-28">
			<div className="bg-_purple h-[650px] rounded-3xl grid grid-cols-2 items-center relative overflow-hidden">
				...
				<div class="h-8 w-16 rounded-tl-full rounded-tr-full overflow-hidden absolute bottom-0 left-96 bg-_orange"></div>
				...
				<div class="h-4 w-4 rounded-full overflow-hidden absolute top-36 left-[466px] bg-_orange z-10"></div>
				<div class="h-12 w-12 rounded-full overflow-hidden absolute top-32 left-[450px] bg-_lightOrange"></div>
				<div class="h-4 w-12 rotate-12 rounded-t-full absolute top-24 left-[500px] bg-_green"></div>
				<div class="h-8 w-8 rounded-full overflow-hidden absolute top-16 left-[600px] bg-_lightOrange"></div>
			</div>
		</div>
	);
}
